...
public class Methods {
	...
	public double select(Products product) {
		...
		do {	
			...
			product.setProductNumber(scan.nextInt());
			if(product.getProductNumber()<1 || product.getProductNumber()>10) {
				System.out.println("Please enter a valid product number");
			}
		}while(product.getProductNumber()<1 || product.getProductNumber()>10);
		
		switch(product.getProductNumber()) {
        case 1:
